...
insert into posts (user_id, post_type_id, title, body, answer, date_time, employer) values (19, 1, 'I got interviewed by SWBC, this is what they asked', 'Tell me about some software projects you have worked on.','I just told them about my projects from Codeup and the projects i did at home', '10/31/2019', 'SWBC');
insert into posts (user_id, post_type_id, title, body, answer, date_time, employer) values (8, 1,  'Just a question i though of in case your applying at a job that uses MySQL','What is a join in MySQL?','Services', '4/25/2019', 'Alumnus');
...
insert into post_comments (body, date_time, post_id, user_id) values ('Prestium Pharma, Inc.', '4/29/2019', 3, 13);
insert into post_comments (body, date_time, post_id, user_id) values ('McKesson Contract Packaging', '7/24/2019', 15, 2);
insert into post_comments (body, date_time, post_id, user_id) values ('Air Liquide Healthcare America Corporation', '2/22/2020', 1, 6);
...
insert into post_comments (body, date_time, post_id, user_id) values ('Guerlain', '5/14/2019', 4, 9);
insert into post_comments (body, date_time, post_id, user_id) values ('Physicians Total Care, Inc.', '1/18/2020', 12, 6);
insert into post_comments (body, date_time, post_id, user_id) values ('Unit Dose Services', '9/26/2019', 13, 18);
...
insert into post_comments (body, date_time, post_id, user_id) values ('BioActive Nutritional, Inc.', '7/29/2019', 12, 14);
insert into post_comments (body, date_time, post_id, user_id) values ('Nelco Laboratories, Inc.', '11/9/2019', 8, 7);
insert into post_comments (body, date_time, post_id, user_id) values ('Digestive Care, Inc.', '8/28/2019', 11, 2);
...
insert into post_comments (body, date_time, post_id, user_id) values ('Natural Health Supply', '6/29/2019', 6, 17);
